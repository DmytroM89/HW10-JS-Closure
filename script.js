...
Заменить var на let. Поскольку for создаёт для let блочную область видимости, то для каждой итерации будет создаваться отдельная переменная с разным значением.
 */
for (let i = 1; i <= 10; i++) {
    setTimeout(function() {
        console.log(i);
